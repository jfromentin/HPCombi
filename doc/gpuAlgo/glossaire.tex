...
%%%%%%%%%%%%%%%%%%%%%%%%%CUDA/GPU
\newglossaryentry{cpu}{ name=CPU, text=CPU, first=CPU (\emph{Central Processing Unit}), firstplural=CPU (\emph{Central Processing Units}), plural=CPUs, description={Central Processing Unit} }
\newglossaryentry{CPU}{ type=noprint, name=CPU, text=CPU, first=CPU (\emph{Central Processing Unit}), firstplural=CPU (\emph{Central Processing Units}), plural=CPUs, description={Central Processing Unit} }
\newglossaryentry{gpu}{ name=GPU, text=GPU, first=GPU (\emph{Graphics Processing Unit}), firstplural=GPU (\emph{Graphics Processing Units}), plural=GPUs, description={Graphics Processing Unit} }
\newglossaryentry{GPU}{ type=noprint, name=GPU, text=GPU, first=GPU (\emph{Graphics Processing Unit}), firstplural=GPU (\emph{Graphics Processing Units}), plural=GPUs, description={} }
...
\newglossaryentry{gm}{ name=global memory, description={\gls{gpu} Global Memory} }
\newglossaryentry{reg}{ name=registre, description={Mémoire interne a un \gls{cpu}} }
\newglossaryentry{sharedfr}{ name=mémoire partagée, description={Mémoire partagée dans un \gls{bloc} de \glspl{th} d'un \gls{gpu}} }
\newglossaryentry{shared}{ name=shared memory, description=Shared memory within a \gls{gpu} \glspl{th} \gls{bloc}}
...
\newglossaryentry{block}{ name=block, plural=blocks, description={\gls{gpu} \glspl{th} block} }
...
\newglossaryentry{ual}{ name=ALU, text=ALU, first=\emph{unité arithmétique et logique} (ALU), description={Unité arithmétique et logique}, plural={ALU}, firstplural={\emph{unités arithmétiques et logiques} (ALU)} }
\newglossaryentry{alu}{ name=ALU, text=ALU, first=\emph{arithmetic logic unit} (ALU), description={Arithmetic logic unit}, plural={ALUs}, firstplural={\emph{Arithmetic logic units} (ALU)} }
...
\newglossaryentry{1080}{ type=noprint, name=\gls{nvidia} GTX 1080, text=GTX 1080, first=\gls{nvidia} GTX 1080 (2016) , description={} }
